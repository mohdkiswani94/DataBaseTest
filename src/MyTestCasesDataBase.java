...
public class MyTestCasesDataBase {
	...
	public void addData() throws SQLException {
		...
		String Query = "INSERT INTO customers (customerNumber, customerName, contactLastName, contactFirstName, phone, addressLine1, city,country )"
				+ "VALUES (55, 'hamzeh', 'abc', 'kiswani', '123-456-7890', 'Amman', 'Amman' ,'jordan')";
	...
	public void updateData() throws SQLException {
		...
		String Query = "update customers set customerName = 'mohammed' where customerNumber = 55 ";
	...
	public void getData() throws SQLException {
		stmt = con.createStatement();
		rs = stmt.executeQuery("select * from customers where customerNumber =55");
	...
	public void DeleteData() throws SQLException {
		...
		String Query = "delete from customers where customerNumber = 55";
